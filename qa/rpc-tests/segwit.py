...
from test_framework.address import script_to_p2sh, key_to_p2pkh, keyhash_to_p2pkh, scripthash_to_p2sh, convert_btc_address_to_proxima
...
def create_witnessprogram(version, node, utxo, pubkey, encode_p2sh, amount):
    ...
    DUMMY_P2SH = convert_btc_address_to_proxima("2MySexEGVzZpRgNQ1JdjdP5bRETznm3roQ2") # P2SH of "OP_1 OP_DROP"
...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        uncompressed_spendable_address = [convert_btc_address_to_proxima("mvozP4UwyGD2mGZU4D2eMvMLPB9WkMmMQu")]
        self.nodes[0].importprivkey("cNC8eQ5dg3mFAVePDX4ddmPYpPbw41r9bm2jd1nLJT77e6RrzTRR")
        compressed_spendable_address = [convert_btc_address_to_proxima("mmWQubrDomqpgSYekvsU7HWEVjLFHAakLe")]
        ...
        unknown_address = [convert_btc_address_to_proxima("mtKKyoHabkk6e4ppT7NaM7THqPUt7AzPrT"), convert_btc_address_to_proxima("2NDP3jLWAFT8NDAiUa9qiE6oBt2awmMq7Dx")]
        ...
        unsolvable_address = [convert_btc_address_to_proxima("mjoE3sSrb8ByYEvgnC3Aox86u1CHnfJA4V"), convert_btc_address_to_proxima("2N7MGY19ti4KDMSzRfPAssP6Pxyuxoi6jLe"), script_to_p2sh(op1), script_to_p2sh(op0)]
        ...
        uncompressed_spendable_address = [convert_btc_address_to_proxima("mguN2vNSCEUh6rJaXoAVwY3YZwZvEmf5xi")]
        self.nodes[0].importprivkey("cMcrXaaUC48ZKpcyydfFo8PxHAjpsYLhdsp6nmtB3E2ER9UUHWnw")
        compressed_spendable_address = [convert_btc_address_to_proxima("n1UNmpmbVUJ9ytXYXiurmGPQ3TRrXqPWKL")]

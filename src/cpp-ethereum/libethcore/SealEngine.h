...
////////////////////////////////////////////////////////////// // proxima
	void setProximaSchedule(EVMSchedule _proximaSchedule) const { proximaSchedule = _proximaSchedule; }

	EVMSchedule& getProximaSchedule() const { return proximaSchedule; }
...
private:
	...
	mutable EVMSchedule proximaSchedule; // proxima

...
#include "genesis/proximaMainNetwork.cpp"
#include "genesis/proximaTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::proximaMainNetwork: return c_genesisInfoProximaMainNetwork;
	case Network::proximaTestNetwork: return c_genesisInfoProximaTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::proximaMainNetwork: return c_genesisStateRootProximaMainNetwork;
	case Network::proximaTestNetwork: return c_genesisStateRootProximaTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}

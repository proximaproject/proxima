...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // proxima
        hashUTXORoot.SetNull(); // proxima
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //proxima
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //proxima
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //proxima
    {

...
/////////////////////////////////////////// proxima
#include <proxima/proximastate.h>
#include <proxima/proximaDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <proxima/storageresults.h>


extern std::unique_ptr<ProximaState> globalState;
...
using ExtractProximaTX = std::pair<std::vector<ProximaTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const size_t MAX_CONTRACT_VOUTS = 1000; // proxima
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashProximaRoot,
    const dev::h256& oldHashStateRoot, const std::vector<ProximaTransaction>& transactions);
...
class ProximaTxConverter{

public:

    ProximaTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransactionRef>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionProximaTransactions(ExtractProximaTX& proximaTx);
...
private:
    ...
    ProximaTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<ProximaTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}

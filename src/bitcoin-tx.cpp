...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s proxima-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  proxima-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded proxima transaction") + "\n" +
              "  proxima-tx [options] -create [commands]   " + _("Create hex-encoded proxima transaction") + "\n" +
              "\n";
...
static void MutateTxAddInput(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    static const unsigned int maxVout = dgpMaxBlockSize / minTxOutSz; // proxima

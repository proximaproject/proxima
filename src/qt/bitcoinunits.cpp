...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PROX");
    case mBTC: return QString("mPROX");
    case uBTC: return QString::fromUtf8("μPROX");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("PROX");
    case mBTC: return QString("Milli-PROX (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-PROX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}

...
void RPCNestedTests::rpcNestedTests()
{
    ...
    globalState = std::unique_ptr<ProximaState>(new ProximaState(dev::u256(0), ProximaState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
    dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::proximaTestNetwork)));

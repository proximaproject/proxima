#ifndef PROXTRANSACTION_H
#define PROXTRANSACTION_H
...
class ProximaTransaction : public dev::eth::Transaction{

public:

    ProximaTransaction() : nVout(0) {}

    ProximaTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    ProximaTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
